...
class ShortenFunctionWidget extends StatelessWidget {
  const ShortenFunctionWidget({super.key, required this.navigationShell});
                  ...
                  AppLocalizations.supportedLocales
                      .map(
                        (locale) => MenuItemButton(
                          ...
                          child: Text(
                            locale.languageCode.toCapitalized,
                            style: TextStyle(
                              fontSize: 20,
                              color: AppColor.getWhiteBlack(context),
                            ),
